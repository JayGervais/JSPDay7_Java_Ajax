...
public class Bookingdetail implements Serializable {
	...
	public Bookingdetail(int bookingDetailId, BigDecimal agencyCommission, BigDecimal basePrice, String classId,
			String description, String destination, String feeId, double itineraryNo, int productSupplierId,
			String regionId, Date tripEnd, Date tripStart, Booking booking) {
		super();
